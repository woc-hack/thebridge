...
class Commit(GitObject):
    ...
    def files(self):
        ...
        return tuple(file_name
                     for file_name in (data and data.split(";")) or [] if
                     file_name and file_name != 'EMPTY')
...
class Project(_Base):
    ...
    def toURL(self):
      ...
      '''
        ...
        for URL in toUrlMap.keys():
            URL_ = URL + "_"
            if p_name.startswith(URL_) and (
                    p_name.count('_') >= 2 or URL == "sourceforge.net"):
    ...
    def author_names(self):
        ...
        return tuple(author_name
                     for author_name in (data and data.split(";")) or [] if
                     author_name and author_name != 'EMPTY')
